import{_ as s,c as a,a1 as p,o as e}from"./chunks/framework.B0cMFUTE.js";const u=JSON.parse('{"title":"3.Command Line","description":"","frontmatter":{"title":"3.Command Line"},"headers":[],"relativePath":"engineer/rollup/3.command-line.md","filePath":"engineer/rollup/3.command-line.md"}'),l={name:"engineer/rollup/3.command-line.md"};function t(i,n,c,o,r,d){return e(),a("div",null,n[0]||(n[0]=[p(`<p>上一节说到了 <code>rollup -c</code> 这个基础指令，除此以外，还有<a href="https://cn.rollupjs.org/command-line-interface/#command-line-flags" target="_blank" rel="noreferrer">其他指令</a>：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>-c, --config &lt;filename&gt;     使用此配置文件</span></span>
