...
<span class="line"><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">  &#39;@my-company/*&#39;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">:</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">    access</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">$authenticated</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">#</span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"> // url -&gt; https://somedomain.org/my_prefix/</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># VERDACCIO_PUBLIC_URL=&#39;https://somedomain.org&#39;;</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># url_prefix: &#39;/&#39;</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">#</span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"> // url -&gt; https://somedomain.org/</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">#</span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"> // url -&gt; https://somedomain.org/second_prefix/&#39;</span></span>
<span class="line"></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">#    const signedUrl =</span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"> // generate a signed url</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">#   web: en-US</span></span></code></pre></div><h2 id="_6-权限控制" tabindex="-1">6.权限控制 <a class="header-anchor" href="#_6-权限控制" aria-label="Permalink to &quot;6.权限控制&quot;">​</a></h2><p><code>verdaccio</code> 的权限控制比较简陋。</p><p>目前的方案是，将 <code>config.yaml</code> 中的 <code>max_users</code> 设置为 <code>1</code>，只允许注册一个账号。</p><p>其他配置使用 <code>config.yaml</code> 的默认配置即可。</p><p>这样，发布和删除包，可以使用已注册的账号。而访问包，在内网环境下的所有人均可以。</p><h2 id="_7-持久化" tabindex="-1">7.持久化 <a class="header-anchor" href="#_7-持久化" aria-label="Permalink to &quot;7.持久化&quot;">​</a></h2><p>利用 <code>pm2</code> 启动 <code>verdaccio</code> 以在后台运行：</p><div class="language-shell vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">pm2</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> start</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> verdaccio</span></span></code></pre></div><h2 id="_8-参考文章" tabindex="-1">8.参考文章 <a class="header-anchor" href="#_8-参考文章" aria-label="Permalink to &quot;8.参考文章&quot;">​</a></h2><ol><li><p><a href="https://juejin.cn/post/6953115364511186975" target="_blank" rel="noreferrer">私有npm仓库</a></p></li><li><p><a href="https://zhaomenghuan.js.org/blog/npm-private-repository-verdaccio.html" target="_blank" rel="noreferrer">npm 私有仓库工具 Verdaccio 搭建</a></p></li><li><p><a href="http://www.wynneit.cn/2021/07/12/verdaccio/" target="_blank" rel="noreferrer">搭建属于自己的私有npm库</a></p></li></ol>`,37)]))}const g=i(p,[["render",t]]);export{d as __pageData,g as default};
