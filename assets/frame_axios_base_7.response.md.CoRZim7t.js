import{_ as a,c as i,o as n,b0 as e}from"./chunks/framework.D8aj9ziZ.js";const c=JSON.parse('{"title":"7.response","description":"","frontmatter":{"title":"7.response"},"headers":[],"relativePath":"frame/axios/base/7.response.md","filePath":"frame/axios/base/7.response.md","lastUpdated":1749892205000}'),t={name:"frame/axios/base/7.response.md"};function p(l,s,h,r,k,d){return n(),i("div",null,s[0]||(s[0]=[e(`<p>在上一节中，我们打印了响应拦截器中的 <code>response</code>。</p><p><img src="https://raw.githubusercontent.com/oneyoung19/vuepress-blog-img/main/img/20230218160158.png" alt="" loading="lazy"></p><p>我们对这几项属性做一下对应说明：</p><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">{</span></span>
