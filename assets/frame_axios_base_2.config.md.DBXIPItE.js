import{_ as i,o as a,c as n,b0 as l}from"./chunks/framework.CkgpWotD.js";const g=JSON.parse('{"title":"2.config","description":"","frontmatter":{"title":"2.config"},"headers":[],"relativePath":"frame/axios/base/2.config.md","filePath":"frame/axios/base/2.config.md","lastUpdated":1737464486000}'),p={name:"frame/axios/base/2.config.md"};function h(t,s,e,k,r,E){return a(),n("div",null,s[0]||(s[0]=[l(`<p>在安装完 <code>axios</code> 依赖之后，我们就可以开始使用，譬如：</p><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> axios </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;axios&#39;</span></span>
