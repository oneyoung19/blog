import{_ as i,o as a,c as n,b0 as p}from"./chunks/framework.DDuwZS-e.js";const o=JSON.parse('{"title":"2.IIFE","description":"","frontmatter":{"title":"2.IIFE"},"headers":[],"relativePath":"FE/js-advance/module/2.IIFE.md","filePath":"FE/js-advance/module/2.IIFE.md","lastUpdated":1737711090000}'),l={name:"FE/js-advance/module/2.IIFE.md"};function e(t,s,h,k,d,c){return a(),n("div",null,s[0]||(s[0]=[p(`<p><code>IIFE</code> 意为 <code>Immediately Invoked Functions Expression</code>。</p><p>它指的是<strong>在定义时就会立即执行的函数</strong>。</p><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">function</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> () {</span></span>
